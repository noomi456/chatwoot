...
- `ChatRing::AssistantSpike` exposes the compile-time public-response gate only; no deterministic spike or alternate runtime may bypass the v2.2 production path and release gates.
